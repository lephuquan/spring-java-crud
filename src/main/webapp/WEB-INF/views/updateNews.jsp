...
<div class="container">
	...
	<form:form  action="postUpdateNews" modelAttribute="news" method="post">
	
	ID  <form:input path="newId" readonly="true" type="text"/>
	<form:errors path="newId" cssClass="error"></form:errors>
	<br/>
	<br/>
